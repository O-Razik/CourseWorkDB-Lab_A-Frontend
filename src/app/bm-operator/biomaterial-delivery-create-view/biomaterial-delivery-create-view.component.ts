...
} from '../../shared/views/list-views/biomaterial-collection-list-view/biomaterial-collection-list-view.component';
import {
  AnalysisCenterSubListViewComponent
} from '../../shared/views/sub-list-views/analysis-center-sub-list-view/analysis-center-sub-list-view.component';
import {
