...
import {AnalysisListViewComponent} from './shared/views/analysis-list-view/analysis-list-view.component';
import {LaboratoryListViewComponent} from './shared/views/laboratory-list-view/laboratory-list-view.component';
import {OrderListViewComponent} from './shared/views/order-list-view/order-list-view.component';
import {EmployeeListViewComponent} from './shared/views/employee-list-view/employee-list-view.component';
import {ClientListViewComponent} from './shared/views/client-list-view/client-list-view.component';
import {AnalysisResultListViewComponent} from './shared/views/analysis-result-list-view/analysis-result-list-view.component';
import {InventoryInLaboratoryListViewComponent} from './shared/views/inventory-in-laboratory-list-view/inventory-in-laboratory-list-view.component';
import {InventoryOrderListViewComponent} from './shared/views/inventory-order-list-view/inventory-order-list-view.component';
import {BiomaterialCollectionListViewComponent} from './shared/views/biomaterial-collection-list-view/biomaterial-collection-list-view.component';
import {BiomaterialDeliveryListViewComponent} from './shared/views/biomaterial-delivery-list-view/biomaterial-delivery-list-view.component';
