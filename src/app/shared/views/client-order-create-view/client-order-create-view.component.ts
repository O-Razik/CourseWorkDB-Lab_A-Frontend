...
import { InventoryInLaboratoryListViewComponent } from '../inventory-in-laboratory-list-view/inventory-in-laboratory-list-view.component';
import { AnalysisListViewComponent } from '../analysis-list-view/analysis-list-view.component';
